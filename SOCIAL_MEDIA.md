...
Get a jump start on your workweek with DevOps'ish XXX — DESC https://devopsish.com/XXX #DevOps #Cloud #Kubernetes #AI #Tech #News #Newsletter
...
DevOps'ish is built by me, open source leader, #Kubernetes contributor, and #DevOps practitioner, Chris Short. Subscribe today for the latest in Cloud Native, DevOps, Open Source, AI, tech industry news, culture, and the 'ish between! https://devopsish.com/subscribe

### Thursday PM (1-2 PM, Random Subscribe Giphy)

Never heard of DevOps'ish? It's a newsletter covering Cloud Native, DevOps, Open Source, AI, tech industry news, culture, and the 'ish between. It's opinionated, geared toward increasing knowledge, and improving skills. Subscribe now! https://devopsish.com/subscribe #Cloud #DevOps #Kubernetes #AI #Tech

OR

Most of these posts with the #devopsish hashtag land in a newsletter I write called, DevOps'ish. "Cloud Native, DevOps, Open Source, AI, tech industry news, culture, and the 'ish between." Sound like something you could benefit from? Subscribe here: https://devopsish.com/subscribe
