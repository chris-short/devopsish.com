...
**Technical Note**: I'm testing [campaign parameters](https://ga-dev-tools.appspot.com/campaign-url-builder/) this week. This will tell places being linked to where the click came from (this newsletter). If you think this is an issue or cause for concern, let me know. The logic is it helps writers know where their readers are. As I try to link to more practitioners sites' it'll give them an idea of where traffic is coming from. Also, I desperately need someone or something to help me manage sponsors. Life this week has shown me it's beyond my logistical limits with everything that's being juggled at the moment. Any suggestions here would be awesome.
