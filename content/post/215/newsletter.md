...
description = ["Prepping for KubeCon, we're languishing, CodeCov debacle, open source is still not a business model, Signal slashes Cellebrite, not so Golden Gophers, ARM deal halted, Kubernetes Gateway API, and more"]
draft = false
slug = "215"
...
title = "DevOps'ish 215: Prepping for KubeCon, we're languishing, CodeCov debacle, open source is still not a business model, Signal slashes Cellebrite, not so Golden Gophers, ARM deal halted, Kubernetes Gateway API, and more"
