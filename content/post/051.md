...
# DevOps'ish 051: Highs and Lows, Thankfulness, Kubernetes, tmux, and More
...
[I just don't want to be a software developer anymore](https://medium.com/@melissamcewen/i-just-dont-want-to-be-a-software-developer-anymore-a371422069a1) by [melissa mcewen](undefined): I still love coding, but I hate this industry
...
[Security problems of Kops default deployments](https://medium.com/@jossctz/security-problems-of-kops-default-deployments-2819c157bc90): In this article [Josselin Costanzi](undefined) will start from a one-liner and demonstrate the security flaws of the default deployment.
...
[Our Journey to Zero Failed Installs](https://medium.com/@packet/our-journey-to-zero-failed-installs-8fb0ed93c8fd) by [Packet](undefined): "When you provision 50,000 servers per month, failures are inevitable. But we made it a goal: get to 100% provisions for one day. Here's how we did it."
...
[Fewer unit tests more logs](https://hackernoon.com/less-unit-tests-more-logs-8acbfedc24a0): A controversial idea from [Mike Sedzielewski](undefined).
...
<iframe src="https://medium.com/media/d45653ecc15d4991a2c97c3716932968" frameborder=0></iframe>
