...
# DevOps'ish 052: 1 Year 🎉, CNI Book Giveaway, AWS re:Invent, Kubernetes, and More!

Flight of the Hammerheads from Digital Blasphemy
...
1. [DevOps'ish 035: Google's Toxicity, Security, SRE, Kubernetes, and More!](https://devopsish.com/devopsish-035-google-s-toxicity-security-sre-kubernetes-and-more-f4bfadd192c7?source=collection_archive---------0----------------)

1. [DevOps'ish 045: Sick Days, Kubernetes, Kaspersky, Go, AWS, and More!](https://devopsish.com/devopsish-045-sick-days-kubernetes-kaspersky-go-aws-and-more-c1dba1d87313?source=collection_archive---------1----------------)

1. [DevOps'ish 040: Solaris, Observability, Shift Left, Ansible, and More](https://devopsish.com/devopsish-040-solaris-observability-shift-left-ansible-and-more-105ad2da1a4c?source=collection_archive---------2----------------)

1. [DevOps'ish 037: Google, Debian, MongoDB, Kubernetes, and More!](https://devopsish.com/devopsish-037-google-debian-mongodb-kubernetes-and-more-ce2f96fa004c?source=collection_archive---------3----------------)

1. [DevOps'ish Weekly — 014: Week of 1489294800](https://devopsish.com/devopsish-weekly-014-week-of-1489294800-ca73bd9bd25e?source=collection_archive---------4----------------)
...
[My First Few Months as a Junior Engineer](https://medium.com/@erinkayfox/my-first-few-months-as-a-junior-engineer-c0155691007) by [Erin Fox](undefined): "We should all compare ourselves, to our past selves to really see how far we've come and how much we've learned."
...
[May the next Etsy learn its lessons](https://m.signalvnoise.com/may-the-next-etsy-learn-its-lessons-af9928218114) by [DHH](undefined)
...
[a short example of why dimensions are suuuuuper valuable](https://medium.com/@mhat/a-short-example-of-why-dimensions-are-suuuuuper-valuable-67e880055eb0) by [Matt Knopp](undefined)
...
[Say Hello to AWS Fargate & Amazon Elastic Container Service for Kubernetes (EKS)](https://medium.com/containers-on-aws/say-hello-to-amazon-fargate-and-amazon-elastic-container-service-for-kubernetes-66707dd14976) by [tiffany jernigan](undefined): "No more needing to provision, configure, or manage any clusters or instances!"
...
[Welcoming AWS to the Kubernetes ecosystem, and introducing a new open source project for Kubernetes authentication](https://blog.heptio.com/welcoming-aws-to-the-kubernetes-ecosystem-and-introducing-a-new-open-source-project-for-kubernetes-200a6085ca6c) by [Craig McLuckie](undefined)

[Kubernetes: Getting Started](https://chrisshort.net/kubernetes-getting-started/) by [Chris Short](undefined): How do you get started with "an open-source system for automating deployment, scaling, and management of containerized applications"?
...
SysAdvent [Day 2 — Shifting Left Securely With inSpec](https://sysadvent.blogspot.com/2017/12/day-2-shifting-left-securely-with-inspec.html) by [Matt Stratton](undefined) and Rich Cassara
...
<iframe src="https://medium.com/media/190c86fd476140fcf000ff64fb453f10" frameborder=0></iframe>
