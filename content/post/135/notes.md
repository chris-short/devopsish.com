[If you have to ask…. OpenEBS 1.0 - MayaData - Medium](https://medium.com/mayadata/if-you-have-to-ask-openebs-1-0-dd4a1663c8a9)
[Microsoft is teasing Windows 1.0 — yes, from 1985 — for a mystery Stranger Things tie-in - The Verge](https://www.theverge.com/tldr/2019/7/5/20683448/microsoft-windows-1-0-stranger-things-season-3-upside-down-july-8)
[Making On-Call Not Suck - DEV Community 👩‍💻👨‍💻](https://dev.to/molly_struve/making-on-call-not-suck-490)
[How to use GitLab and Ansible to create infrastructure as code | GitLab](https://about.gitlab.com/2019/07/01/using-ansible-and-gitlab-as-infrastructure-for-code/)
[Why I quit a $500K job at Amazon to work for myself](https://danielvassallo.com/only-intrinsic-motivation-lasts/)
[When Passion Leads to Burnout](https://hbr.org/2019/07/when-passion-leads-to-burnout)
[The Infrastructure Mess Causing Countless Internet Outages | WIRED](https://www.wired.com/story/bgp-route-leak-internet-outage/)
[Kube Forwarder – Easy to use Kubernetes port forwarding manager](https://kube-forwarder.pixelpoint.io/?utm_source=share&utm_medium=ios_app)
[Running Kubernetes on Ephemeral Infrastructure - CTOvision.com](https://ctovision.com/running-kubernetes-on-ephemeral-infrastructure/)
...
[Intro to containers, Kubernetes, and Red Hat OpenShift (DO180)](https://www.redhat.com/en/services/training/do180-introduction-containers-kubernetes-red-hat-openshift)
