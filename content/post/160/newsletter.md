...
draft = false
slug = "160"
tags = ["DevOps", "Kubernetes", "developers", "open source", "Linux", "security", "cloud", "cloud native", "performance", "Apple", "CNCF", "CNCF Ambassador", "MinIO", "Detroit", "geolite", "Bongo", "Operator", "sysadmin", "entropy", "VMware", "Red Hat", "velocity", "CI/CD", "Kubernetes Operators"]
