...
This is creepy. AdsWizz, a digital audio adtech company, that Pandora acquired (Pandora merged with SiriusXM in 2019) is being put to work in a new way, by powering a product called AudioID. "The company explains that it looks for signals in the data sets that overlap. So, for example, if a customer signed up with the same email address across both Pandora and Stitcher, SiriusXM can combine those accounts into a single 'AudioID.'" It also looks for overlapping datasets between the services.
...
Right to repair until recently has been a fundamental part of owning something. It's odd that this has become a "political" issue. It's even weirder to read articles like this one [about right to repair in Massachusetts](https://arstechnica.com/cars/2022/02/a-fight-over-the-right-to-repair-cars-turns-ugly/).
...
Cobalt, Ontario, Canada, a mere 381 miles from where I'm writing this newsletter, is the scene for this article that talk about the cobalt industry. "The story of Cobalt is about the looting of one of the great treasure boxes of the earth. But it is also a story of people who believed it was possible to create an alternate future with this immense natural wealth." Yeah, it's bad.
...
Well this is no good. From their TLDR...
...
That's a good start. I gotta be honest, this might have been poorly timed given the recent [shenanigans in the npm community](https://www.yahoo.com/now/developer-sabotaged-own-open-source-185931413.html). This would do nothing to prevent the situation that occurred last month. I am curious what big Node.js shops are doing to try to mitigate issues like developer sabotage. Remember [this happen to Chef in 2019](https://chrisshort.net/seth-vargo-says-hell-noputs-chef-on-ice/). Are y'all running caches for your CI? How are you verifying what that cache is pulling in actually works? This is a tough problem to solve.
...
The halls of Killed by Google get a quick entrant. I hate to say I saw this coming but, the gaming industry is tough and takes years of runway sometimes. But, that underlying infrastructure and those lessons learned will make it interesting to see how this white-label service fares.
...
I mean this is where you cut your teeth if you're in ops. Linux system administrator is a foundational layer of mine and a lot of readers careers. I was kinda forced to learn to put parts and pieces together. But, nowadays, thanks to a lot of advances on a lot of fronts, today's DevOps folks might be more dev heavy than ops. Cool article.
...
Scan your networks, folks. Check you IP in <shodan.io> every once in a while.
