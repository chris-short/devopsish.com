...
[Kubernetes v1.36: PSI Metrics for Kubernetes Graduates to GA](https://kubernetes.io/blog/2026/05/12/kubernetes-v1-36-psi-metrics-ga/) - Pressure Stall Information metrics for monitoring resource contention at node, pod, and container levels are now stable in v1.36, with performance testing confirming minimal overhead even under high-density workloads.
